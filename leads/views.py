...
# NOTE: there are both class-based views and function-based views
...
class CategoryDetailView(LoginRequiredMixin, generic.DetailView):
    ...
    # use the below code for complex queries but otherwise modify code in template...check category_detail.html
    # def get_context_data(self, **kwargs):
